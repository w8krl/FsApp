...
const AnimatedText = ({ text }) => {
  ...
  const totalAnimationTime = Math.min(1, words.reduce((acc, word) => acc + word.length * 0.1, 0) + words.length * 2);
  ...
  return (
    <AnimatedTextContainer delay={0.1} className={isCentered ? 'text-centered' : ''}>
